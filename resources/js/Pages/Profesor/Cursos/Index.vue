        ...
        <div class="py-8">
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <Link :href="route('profesor.cursos.create')" class="bg-slate-900 text-white px-5 py-2.5 rounded-lg font-medium hover:bg-slate-800 transition shadow-sm flex items-center gap-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div v-for="curso in cursosFiltrados" :key="curso.id" class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden hover:shadow-md transition flex flex-col">
                        ...
                        <div class="p-5 flex-1 flex flex-col">
                            ...
                            <Link :href="route('profesor.cursos.edit', curso.id)" class="block w-full text-center py-2.5 bg-slate-900 hover:bg-slate-800 text-white rounded-lg text-sm font-medium transition-colors">
                                Gestionar Curso
                            </Link>
                        </div>
                    </div>
